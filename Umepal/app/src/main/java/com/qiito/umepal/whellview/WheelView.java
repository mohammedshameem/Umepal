package com.qiito.umepal.whellview;
...
public class WheelView extends View {
  ...
  /*  private static final int[] SHADOWS_COLORS = new int[] { 0xFF111111,
	 ...
	 * Constructor
	 */
	public WheelView(Context context,boolean shadow) {
		super(context);
		this.shadow=shadow;
		initData(context);
	}
	...
	public OnWheelItemClickListener getmOnItemClickListener() {
		return mOnItemClickListener;
	}

	public void setmOnItemClickListener(OnWheelItemClickListener mOnItemClickListener) {
	...
	public void addChangingListenerkm(OnWheelChangedListener listener) {
		changingListeners.add(listener);
	}
	...
	public void addScrollingListenerkm(OnWheelScrollListener listener) {
		scrollingListeners.add(listener);
	}
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		// TODO: make it static
		itemsLayout.setLayoutParams(new RadioGroup.LayoutParams(RadioGroup.LayoutParams.WRAP_CONTENT,
